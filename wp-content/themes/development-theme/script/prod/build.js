...
},{"vue":27}],25:[function(require,module,exports){
/*!
 * vue-resource v1.2.0
...
},{"got":2}],26:[function(require,module,exports){
(function (process){
/**
  * vue-router v2.2.1
  * (c) 2017 Evan You
	...
	created: function created() {
		...
		eventHub.$on('accordionProcess', function (dropinfo) {
			if (dropinfo.scope === _this.scope && dropinfo.slot != _this.slotname) {
				...
				$(_this.elemContent).animate({ height: 0 }, _this.speed);
			}
		});
	},
		...
		invokeDropdown: function invokeDropdown(event) {
			...
			if ($(event.target).hasClass('dropdown-heading')) {
				...
				if (this.mutableCollapsed) {
					...
					$(this.elemContent).animate({ height: this.originHeight }, this.speed, 'linear', function () {
						$(_this2.elemContent).height('auto');
						_this2.originHeight = _this2.elemContent.offsetHeight;
					});
				}
			}
		}
...
},{"../../vuex/User":50,"babel-runtime/core-js/number/is-integer":1,"vue":27,"vue-hot-reload-api":23}],32:[function(require,module,exports){
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
...
},{"vue":27,"vue-hot-reload-api":23}],34:[function(require,module,exports){
;(function(){
'use strict';
...
},{"vue":27,"vue-hot-reload-api":23}],35:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flex-container",attrs:{"id":"Profile-scope"}},[(_vm.currentUserModel)?_c('md-list',{staticClass:"md-dense flex-col-20",attrs:{"id":"dashboardnav"}},[_c('md-list-item',{staticClass:"md-primary"},[_c('router-link',{staticClass:"button",attrs:{"to":{path: '/'+_vm.netwoRkUrlendpoint },"exact":""}},[_c('md-icon',[_vm._v("home")]),_vm._v(" "),_c('span',{staticClass:"hidden-on-phones"},[_vm._v("Home Link")])],1)],1),_vm._v(" "),_c('md-list-item',[_c('router-link',{staticClass:"button",attrs:{"to":{path:'/'+_vm.netwoRkUrlendpoint+'/settings'}}},[_c('md-icon',[_vm._v("settings")]),_vm._v(" "),_c('span',{staticClass:"hidden-on-phones"},[_vm._v("Settings")])],1)],1),_vm._v(" "),_c('md-list-item',[_c('router-link',{staticClass:"button",attrs:{"to":{path:'/'+_vm.netwoRkUrlendpoint+'/media'}}},[_c('md-icon',[_vm._v("photo_library")]),_vm._v(" "),_c('span',{staticClass:"hidden-on-phones"},[_vm._v("Media")])],1)],1),_vm._v(" "),_c('md-list-item',[_c('router-link',{staticClass:"button",attrs:{"to":{path:'/'+_vm.netwoRkUrlendpoint+'/auth'}}},[_c('md-icon',[_vm._v("warning")]),_vm._v(" "),_c('span',{staticClass:"hidden-on-phones"},[_vm._v("Auth")])],1)],1)],1):_vm._e(),_vm._v(" "),_c('div',{ref:"networkcontent",staticClass:"flex-col-80",class:{'flex-col-100': !_vm.currentUserModel},attrs:{"id":"network-content"}},[_c('transition',{attrs:{"name":"panelslide"}},[_c('router-view',{staticClass:"view"})],1)],1)],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../../vuex/User":50,"vue":27,"vue-hot-reload-api":23}],36:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
	...
	methods: {
		invokeMove: function invokeMove(e) {
			this.mooving = true;

			var parent = findAncestor(e.target, "Slider-scope");
			...
			if (parent) {
				...
				window.addEventListener('mousemove', function (e) {
					if (vm.mooving) {
						var measure = e.pageX - parentPosition.left,
		...
		movePinThere: function movePinThere(e) {
			var target = e.target,
			    originElem = null,
			    vm = this;
	...
	mounted: function mounted() {
		var vm = this,
		    container = vm.$refs.popovercontentscope;
	}
};
})()
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"sliderscope",staticClass:"Slider-scope",on:{"mousedown":_vm.movePinThere}},[_c('div',{staticClass:"range-handler",style:({width:_vm.pos+'%'})}),_vm._v(" "),_c('span',{staticClass:"dragger",class:{touched:_vm.mooving},style:({left:_vm.pos+'%'}),on:{"mousedown":_vm.invokeMove}},[_c('transition',{attrs:{"enter-active-class":"animated flipInY","leave-active-class":"animated flipOutY"}},[(_vm.showbulb && _vm.mooving)?_c('span',{staticClass:"bulb-handler"},[_c('i',{staticClass:"bulb-percentage"},[_vm._v(_vm._s(Math.ceil(_vm.pos))+"%")])]):_vm._e()])],1)])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-14c6f627", __vue__options__)
  } else {
    hotAPI.reload("data-v-14c6f627", __vue__options__)
  }
})()}
},{"vue":27,"vue-hot-reload-api":23}],37:[function(require,module,exports){
;(function(){
'use strict';
...
},{"vue":27,"vue-hot-reload-api":23}],41:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../vuex/User":50,"vue":27,"vue-hot-reload-api":23}],42:[function(require,module,exports){
...
},{"../../vuex/User":50,"vue":27,"vue-hot-reload-api":23,"vueify/lib/insert-css":28}],43:[function(require,module,exports){
;(function(){
'use strict';
...
},{"vue":27,"vue-hot-reload-api":23}],44:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../vuex/User":50,"vue":27,"vue-hot-reload-api":23}],45:[function(require,module,exports){
;(function(){
'use strict';
   ...
   */
		...
		domready(function () {
			...
			var _loop = function _loop(i) {
				var _elem = hideElemsUntilDomLoaded[i];
				setTimeout(function () {
		...
		var parallaxCanBeUsed = function parallaxCanBeUsed() {
