...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{staticClass:"flex-container",attrs:{"id":"Profile-scope"}},[_h('md-list',{staticClass:"md-dense flex-col-20",class:{'hidden':!_vm.currentUserModel},attrs:{"id":"dashboardnav"}},[_h('md-list-item',{staticClass:"md-primary"},[_h('router-link',{staticClass:"button",attrs:{"to":"/user","exact":""}},[_h('md-icon',["home"])," ",_h('span',["Home Link"])])])," ",_h('md-list-item',[_h('router-link',{staticClass:"button",attrs:{"to":"/user/settings"}},[_h('md-icon',["settings"])," ",_h('span',["Settings"])])])," ",_h('md-list-item',[_h('router-link',{staticClass:"button",attrs:{"to":"/user/media"}},[_h('md-icon',["photo_library"])," ",_h('span',["Media"])])])," ",_h('md-list-item',[_h('router-link',{staticClass:"button",attrs:{"to":"/user/auth"}},[_h('md-icon',["warning"])," ",_h('span',["Auth"])])])])," ",_h('div',{ref:"networkcontent",staticClass:"flex-col-80",class:{'flex-col-100': !_vm.currentUserModel},attrs:{"id":"network-content"}},[_h('transition',{attrs:{"name":"panelslide"}},[_h('router-view',{staticClass:"view"})])])])}
	...
	methods: {
		...
		fetchCart: function fetchCart() {
			this.$http.get(AMdefaults.ajaxurl + "?action=ajx20161412071430").then(function (response) {
				_Cart2.default.commit('setProducts', JSON.parse(response.body));
			});
		},
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{staticClass:"minicart-template-holder"},[_h('button',{staticClass:"mdl-button mdl-js-button mdl-button--icon",on:{"click":_vm.toggleCart}},[_h('i',{staticClass:"material-icons mdl-badge mdl-badge--overlap",attrs:{"data-badge":_vm.totalCart}},["shopping_cart"])])," "," "," ",_h('transition',{attrs:{"name":"fademinicart"}},[_h('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.cartOpened),expression:"cartOpened"}],staticClass:"mdl-list transition-default"},[_vm._l((_vm.cartItemsData),function(item,index){return _h('div',{staticClass:"mdl-list__item"},[_h('div',{staticClass:"mdl-list__item-primary-content"},[_h('figure',[_h('a',{attrs:{"href":item.permalink}},[_h('img',{attrs:{"src":item.images[0],"alt":item.product.post_title}})])])," ",_h('div',{staticClass:"cart-item-description"},[_h('p',{staticClass:"product-title"},[_vm._s(item.product.post_title)])," ",_h('p',{staticClass:"product-title"},[_h('span',{domProps:{"innerHTML":_vm._s(_vm.currency)}}),_vm._s(item.price)+" x "+_vm._s(item.qty)])])])," ",_h('button',{staticClass:"mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--mini-fab",on:{"click":function($event){_vm.removeFromCart(item, index, $event)}}},[_h('i',{staticClass:"material-icons"},["clear"])])])})])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
		...
		loginUser: function loginUser() {
			...
			this.$http.post(AMdefaults.ajaxurl, loginData).then(function (response) {
				...
				if (data.status === 'success') {
					...
					console.log(_User2.default.state.userdata);
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{ref:"authscope",attrs:{"id":"Auth-scope"}},[_h('div',{staticClass:"container"},[_h('div',{staticClass:"col-md-8 col-md-offset-2 animated rubberBand",attrs:{"id":"login-register-form"}},[_h('br')," ",_h('md-card',{attrs:{"id":"login-register-wrapper"}},[_h('md-button',{staticClass:"md-fab",class:{'icon-centered':_vm.currentForm == 'registration'},attrs:{"title":"Registration","id":"register-trigger"},on:{"click":_vm.toggleRegistration}},[_h('md-icon',["border_color"])])," ",_h('md-card-content',{class:{'increase-z':_vm.currentForm == 'registration'},attrs:{"id":"forms-handler"}},[_h('div',{attrs:{"id":"am-loginform-wrapper"}},[_h('md-card-header',[_h('div',{staticClass:"md-title"},["Login"])," ",_h('div',{staticClass:"md-subhead"},["Enter Your login and password"])])," "," ",_h('md-card-content',{attrs:{"id":"am-loginform"}},[_h('form',{attrs:{"action":"","method":"post","role":"form"},on:{"submit":function($event){$event.preventDefault();_vm.loginUser($event)}}},[_h('div',{staticClass:"mdl-textfield mdl-js-textfield mdl-textfield--floating-label"},[_h('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.loginUserModel.login),expression:"loginUserModel.login"}],staticClass:"mdl-textfield__input",attrs:{"type":"text","id":"am-username"},domProps:{"value":_vm._s(_vm.loginUserModel.login)},on:{"input":function($event){if($event.target.composing){ return; }_vm.loginUserModel.login=$event.target.value}}})," ",_h('label',{staticClass:"mdl-textfield__label",attrs:{"for":"am-username"}},["Username"])])," ",_h('div',{staticClass:"mdl-textfield mdl-js-textfield mdl-textfield--floating-label"},[_h('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.loginUserModel.pass),expression:"loginUserModel.pass"}],staticClass:"mdl-textfield__input",attrs:{"type":"password","id":"am-password"},domProps:{"value":_vm._s(_vm.loginUserModel.pass)},on:{"input":function($event){if($event.target.composing){ return; }_vm.loginUserModel.pass=$event.target.value}}})," ",_h('label',{staticClass:"mdl-textfield__label",attrs:{"for":"am-password"}},["Password"])])," ",_h('md-card-actions',[_h('md-button',{staticClass:"md-raised md-accent",attrs:{"type":"submit"}},["Login"])])])])])," "," "," ",_h('md-card-content',{class:{'open-form-opened':_vm.currentForm == 'registration'},attrs:{"id":"am-register-form"}},[_h('div',{attrs:{"id":"register-inner-wrap"}},[_h('md-card-header',[_h('md-button',{staticClass:"md-fab animated",class:{'fadeInRightBig':_vm.currentForm == 'registration'},attrs:{"id":"close-register","title":"Close"},on:{"click":_vm.toggleRegistration}},[_h('md-icon',["close"])])," ",_h('div',{staticClass:"md-title"},["Registration"])," ",_h('div',{staticClass:"md-subhead"},["Subheading title"])])," ",_h('form',{attrs:{"action":""}},[_h('div',{staticClass:"mdl-textfield mdl-js-textfield mdl-textfield--floating-label"},[_h('input',{staticClass:"mdl-textfield__input",attrs:{"type":"email","id":"reg-email"}})," ",_h('label',{staticClass:"mdl-textfield__label",attrs:{"for":"reg-email"}},["Email"])])," ",_h('div',{staticClass:"flex-container"},[_h('div',{staticClass:"mdl-textfield mdl-js-textfield mdl-textfield--floating-label flex-col-50"},[_h('input',{staticClass:"mdl-textfield__input",attrs:{"type":"password","id":"reg-password"}})," ",_h('label',{staticClass:"mdl-textfield__label",attrs:{"for":"reg-password"}},["Password"])])," ",_h('div',{staticClass:"mdl-textfield mdl-js-textfield mdl-textfield--floating-label flex-col-50"},[_h('input',{staticClass:"mdl-textfield__input",attrs:{"type":"password","id":"reg-password-confirm"}})," ",_h('label',{staticClass:"mdl-textfield__label",attrs:{"for":"reg-password-confirm"}},["Password Confirm"])])])," ",_h('md-card-actions',[_h('md-button',{staticClass:"md-raised md-accent animated",class:{'fadeInUpBig':_vm.currentForm == 'registration'},attrs:{"type":"submit"}},["Register\n\t\t\t\t\t\t\t\t\t"])])])])])," "])])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../../vuex/User":22,"vue":7,"vue-hot-reload-api":3}],17:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;return _h('div',{ref:"restrictedscope",attrs:{"id":"Restricted-scope"}},[_h('div',{staticClass:"col-md-8 col-md-offset-2"},[_h('hgroup',{staticClass:"text-center"},[_h('h1',["Bad Request"])," ",_h('h2',[_h('router-link',{attrs:{"to":"/user","exact":""}},[_h('md-icon',["home"])," ",_h('span',["Are you lost?"])])])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
